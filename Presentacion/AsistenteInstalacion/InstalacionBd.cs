...
namespace ORUSCURSO.Presentacion.AsistenteInstalacion
{
    public partial class InstalacionBd : Form
    {
        ...
        private void Reemplazar()
        {
            ...
            txtCrear_procedimientos.Text = txtCrear_procedimientos.Text.Replace("OrusAssistence", TXTbasededatos.Text);
            //***************
            txtEliminarBase.Text = txtEliminarBase.Text.Replace("OrusAssistence", TXTbasededatos.Text);
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("OrusAssistence", txtusuario.Text);
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("OrusAssistence", TXTbasededatos.Text);
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("OrusAssistence", lblcontraseña.Text);
