...
namespace ORUSCURSO.Presentacion
{
    public partial class Personal : UserControl
    {
        ...
        private void Insertar_Personal()
        {
            ...
            parametros.SueldoPorHoras =Convert.ToDouble(txtSueldoHora.Text);
        ...
        {
            DatosPersonal funcion = new DatosPersonal();
            DataTable dt = funcion.MostrarPersonal( desde, hasta);
        ...
        private void InsertarCargos()
        {
            if(!string.IsNullOrEmpty(txtCargoG.Text))
            {
                if(!string.IsNullOrEmpty(txtsueldoG.Text))
                {
                    ...
                    parametros.Cargos = txtCargoG.Text;
                    parametros.SueldoPorHoras = Convert.ToDouble(txtsueldoG.Text);
        ...
        {
            DatosCargos funcion = new DatosCargos();
            DataTable dt = funcion.buscarCargos(txtCargo.Text);
        ...
        {
            DatosPersonal funcion = new DatosPersonal();
            DataTable dt = funcion.BuscarPersonal(desde, hasta,txtbuscador.Text);
            datalistadoPersonal.DataSource = dt;
            DiseñarDtvPersonal();
        }
